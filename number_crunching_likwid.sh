...
likwid-perfctr -g FLOPS_DP ./number_crunching_likwid 10000 >> number_crunching_likwid.out
...
likwid-perfctr -g MEM ./number_crunching_likwid 10000 >> number_crunching_likwid.out
